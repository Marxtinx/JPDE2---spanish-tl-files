# TODO: Translation updated at 2024-08-15 10:49
...
translate spanish strings:
    ...
    new "La mas grande y prominente organización internacional por los derechos de los Faunos, el White Fang empezó desde un deseo de coordinar a un nivel internaciona todas las organizaciones regionales pequeñas y juntar sus recursos y inteligencia. En su primera forma, baho la guía de Ghira y Kalli Belladonna, la organización estaba principalmente involucrada en protestas no violentas, juntas, campañas y influencias politicas. Mediante sus metodos originales ganaron muchas batallas, pero ellos pronto descubrirían un astuto y cruel adversario en la Compañia Schnee."
    ...
    new "La tensión crecia cuando la segunda generación al mando en la compañia usaba su creciente riqueza y influeza para forzar las legislaciones que favorecían a la compañia y sus ejecutivos mientras minimizaban los deerechos de los trabajadores, particularmente en sectores donde la fuerza de trabajo era desproporcionalmente conformada por Faunos. Las tensiones pararon durante los eventos de White Monda, donde los pacificos protestantes se volvieron violentos. Montando esa ola de creciente resentimiento y la derogación de odiada legislación, los Belladonnas abdicaron su posición."
